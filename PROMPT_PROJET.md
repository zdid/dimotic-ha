...
| **Application SUPERVISION** | `fonctionnelles-supervision_specs` | Machines/applications du site (gossip), sélection diffusée, état des sauvegardes — affichée sur la page d'accueil, activée d'office ; première version concrète de SUPERVISION-EXTERNE |
