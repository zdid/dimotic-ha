...
*Version 1.4 - 24 Septembre 2026*
*v1.4 : revue de code — suivi de présence de l'agent reconnecté quand la config MQTT change (restait sur l'ancienne connexion jusqu'au redémarrage) ; un ADCO ne peut appartenir qu'à un compteur (doublon possible en changeant l'ADCO) ; liste des compteurs adoptée en mémoire seulement si l'écriture réussit.*
...
|---------|------|--------|------------|
| 1.4 | 2026-09-24 | Claude | Revue de code : présence de l'agent reconnectée sur changement MQTT, ADCO unique, mémoire alignée sur le disque en cas d'échec d'écriture. v1.3 archivée. |
