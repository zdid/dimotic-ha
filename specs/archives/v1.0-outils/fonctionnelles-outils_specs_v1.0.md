...
Outils **n'exécute jamais** un script : il le génère. C'est l'utilisateur qui le lance, sur la
machine de son choix (par exemple depuis un clone du dépôt pour les scripts de compilation/Docker).
