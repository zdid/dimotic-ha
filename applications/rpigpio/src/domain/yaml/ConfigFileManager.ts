 ...
 * Copie locale du pattern planificateur/rfxcom/arexx (une instance par fichier de données) : pas
 * de dépendance partagée depuis core pour cet utilitaire, chaque app garde la sienne.
 */
