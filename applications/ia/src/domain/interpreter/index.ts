...
// ⭐ 24/09/2026 — outcomesToExecutionSteps() supprimée : elle ne servait qu'à DeployResponder
// (réinterprétation au déclenchement, supprimée — planificateur exécute lui-même la structure).
